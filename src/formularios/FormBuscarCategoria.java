...
public class FormBuscarCategoria extends javax.swing.JFrame {
    
    Categoria categoria = new Categoria();
    
    public FormBuscarCategoria() {
        initComponents();
        this.setLocationRelativeTo(null);
        
        categoria.busquedaPorNombre(jTableCategoria, "");
        categoria.mostrar(jTableCategoria);
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        categoria.busquedaPorNombre(jTableCategoria, txtbusqueda.getText());
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        int fila = jTableCategoria.getSelectedRow();
        if (fila > -1) {
            String idFila = jTableCategoria.getValueAt(fila, 0).toString();
            FormPrincipal.FormCurso.txtIDCategoria.setText(idFila);
            this.dispose();
        }
